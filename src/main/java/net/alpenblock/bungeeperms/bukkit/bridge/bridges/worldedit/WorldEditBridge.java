package net.alpenblock.bungeeperms.bukkit.bridge.bridges.worldedit;
...
public class WorldEditBridge implements Bridge
{
    ...
    {
        Bukkit.getLogger().info("[" + BungeePerms.getInstance().getDescription().getName() + "] Injection of BungeepermsBukkit into WorldEdit");
        try
        {
    ...
    {
        Bukkit.getLogger().info("[" + BungeePerms.getInstance().getDescription().getName() + "] Uninjection of BungeepermsBukkit into WorldEdit");
        try
        {
            WorldEditPlugin we = (WorldEditPlugin) plugin;
