package net.alpenblock.bungeeperms.bukkit.bridge.bridges.essentials;
...
public class EssentialsBridge implements Bridge
{
    ...
    public void enable()
    {
        ...
        if (plugin != null && plugin.isEnabled())
        {
            ...
            Bukkit.getScheduler().runTask(BungeePerms.getInstance(), r);
        }
    }
    ...
    {
        Bukkit.getLogger().info("[" + BungeePerms.getInstance().getDescription().getName() + "] Injection of BungeepermsBukkit into Essentials");
        try
        {
    ...
    {
        Bukkit.getLogger().info("[" + BungeePerms.getInstance().getDescription().getName() + "] Uninjection of BungeepermsBukkit into Essentials");
