...
public class VaultBridge implements Bridge
{
    ...
    {
        Bukkit.getLogger().info("[" + BungeePerms.getInstance().getDescription().getName() + "] Injection of BungeepermsBukkit into Vault");
        try
        {
...
//            f.set(v, Bukkit.getServicesManager().getRegistration(Permission.class).getProvider());
    ...
    {
        Bukkit.getLogger().info("[" + BungeePerms.getInstance().getDescription().getName() + "] Uninjection of BungeepermsBukkit into Vault");
